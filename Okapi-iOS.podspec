Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/trinsic-id/okapi.git", :tag => "#{s.version}" }
  s.source_files  = "objc/Source/Okapi/*.{h,m,mm}"
  s.vendored_libraries = "libs/ios/libokapi.a"
  s.platforms    = { :ios => "12.0" }

  dir = "objc/Source/Pods/Okapi-Proto"
