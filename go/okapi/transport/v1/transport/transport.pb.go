...
import (
	keys "github.com/trinsic-id/okapi/go/okapi/keys/v1/keys"
...
type SignRequest struct {
	...
	Key      *keys.JsonWebKey     `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"`
	AppendTo *pbmse.SignedMessage `protobuf:"bytes,3,opt,name=append_to,json=appendTo,proto3" json:"append_to,omitempty"`
}
...
func (x *SignRequest) GetKey() *keys.JsonWebKey {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *SignRequest) GetAppendTo() *pbmse.SignedMessage {
	if x != nil {
		return x.AppendTo
	}
	return nil
...
type SignResponse struct {
	...
	Message *pbmse.SignedMessage `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
}
...
func (x *SignResponse) GetMessage() *pbmse.SignedMessage {
	if x != nil {
		return x.Message
	}
	return nil
...
func (x *VerifyRequest) GetMessage() *pbmse.SignedMessage {
	if x != nil {
		return x.Message
	}
	return nil
...
func (x *VerifyRequest) GetKey() *keys.JsonWebKey {
	if x != nil {
		return x.Key
	}
	return nil
...
type PackRequest struct {
	...
	SenderKey      *keys.JsonWebKey          `protobuf:"bytes,1,opt,name=sender_key,json=senderKey,proto3" json:"sender_key,omitempty"`
	ReceiverKey    *keys.JsonWebKey          `protobuf:"bytes,2,opt,name=receiver_key,json=receiverKey,proto3" json:"receiver_key,omitempty"`
	...
	Mode           pbmse.EncryptionMode      `protobuf:"varint,5,opt,name=mode,proto3,enum=pbmse.v1.EncryptionMode" json:"mode,omitempty"`
	Algorithm      pbmse.EncryptionAlgorithm `protobuf:"varint,6,opt,name=algorithm,proto3,enum=pbmse.v1.EncryptionAlgorithm" json:"algorithm,omitempty"`
}
...
func (x *PackRequest) GetSenderKey() *keys.JsonWebKey {
	if x != nil {
		return x.SenderKey
	}
	return nil
...
func (x *PackRequest) GetReceiverKey() *keys.JsonWebKey {
	if x != nil {
...
func (x *PackRequest) GetMode() pbmse.EncryptionMode {
	if x != nil {
		return x.Mode
	}
	return pbmse.EncryptionMode(0)
}

func (x *PackRequest) GetAlgorithm() pbmse.EncryptionAlgorithm {
	if x != nil {
		return x.Algorithm
	}
	return pbmse.EncryptionAlgorithm(0)
}
...
type PackResponse struct {
	...
	Message *pbmse.EncryptedMessage `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
}
...
func (x *PackResponse) GetMessage() *pbmse.EncryptedMessage {
	if x != nil {
		return x.Message
	}
	return nil
...
type UnpackRequest struct {
	...
	SenderKey   *keys.JsonWebKey        `protobuf:"bytes,1,opt,name=sender_key,json=senderKey,proto3" json:"sender_key,omitempty"`
	ReceiverKey *keys.JsonWebKey        `protobuf:"bytes,2,opt,name=receiver_key,json=receiverKey,proto3" json:"receiver_key,omitempty"`
	Message     *pbmse.EncryptedMessage `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty"`
}
...
func (x *UnpackRequest) GetSenderKey() *keys.JsonWebKey {
	if x != nil {
		return x.SenderKey
	}
	return nil
...
func (x *UnpackRequest) GetReceiverKey() *keys.JsonWebKey {
	if x != nil {
		return x.ReceiverKey
	}
	return nil
...
func (x *UnpackRequest) GetMessage() *pbmse.EncryptedMessage {
	if x != nil {
		return x.Message
	}
	return nil
...
var file_okapi_transport_v1_transport_proto_rawDesc = []byte{
	...
	0x42, 0x4f, 0x0a, 0x1a, 0x74, 0x72, 0x69, 0x6e, 0x73, 0x69, 0x63, 0x2e, 0x6f, 0x6b, 0x61, 0x70,
	0x69, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x76, 0x31, 0x5a, 0x1c,
	0x6f, 0x6b, 0x61, 0x70, 0x69, 0x2f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x2f,
	0x76, 0x31, 0x2f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0xaa, 0x02, 0x12, 0x4f,
	0x6b, 0x61, 0x70, 0x69, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x56,
...
var file_okapi_transport_v1_transport_proto_goTypes = []interface{}{
	...
	(*keys.JsonWebKey)(nil),        // 9: okapi.keys.v1.JsonWebKey
	(*pbmse.SignedMessage)(nil),    // 10: pbmse.v1.SignedMessage
	(pbmse.EncryptionMode)(0),      // 11: pbmse.v1.EncryptionMode
	(pbmse.EncryptionAlgorithm)(0), // 12: pbmse.v1.EncryptionAlgorithm
	(*pbmse.EncryptedMessage)(nil), // 13: pbmse.v1.EncryptedMessage
}
