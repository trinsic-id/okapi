...
final $typed_data.Uint8List createOberonKeyResponseDescriptor =
    $convert.base64Decode(
        'ChdDcmVhdGVPYmVyb25LZXlSZXNwb25zZRIOCgJzaxgCIAEoDFICc2sSDgoCcGsYAyABKAxSAnBr');
...
final $typed_data.Uint8List createOberonTokenRequestDescriptor =
    $convert.base64Decode(
        'ChhDcmVhdGVPYmVyb25Ub2tlblJlcXVlc3QSDgoCc2sYASABKAxSAnNrEhIKBGRhdGEYAiABKAxSBGRhdGESGgoIYmxpbmRpbmcYAyADKAxSCGJsaW5kaW5n');
...
final $typed_data.Uint8List createOberonProofRequestDescriptor =
    $convert.base64Decode(
        'ChhDcmVhdGVPYmVyb25Qcm9vZlJlcXVlc3QSEgoEZGF0YRgBIAEoDFIEZGF0YRIUCgV0b2tlbhgCIAEoDFIFdG9rZW4SGgoIYmxpbmRpbmcYAyADKAxSCGJsaW5kaW5nEhQKBW5vbmNlGAQgASgMUgVub25jZQ==');
...
final $typed_data.Uint8List verifyOberonProofRequestDescriptor =
    $convert.base64Decode(
        'ChhWZXJpZnlPYmVyb25Qcm9vZlJlcXVlc3QSFAoFcHJvb2YYASABKAxSBXByb29mEhIKBGRhdGEYAiABKAxSBGRhdGESFAoFbm9uY2UYAyABKAxSBW5vbmNlEg4KAnBrGAQgASgMUgJwaw==');
...
final $typed_data.Uint8List blindOberonTokenRequestDescriptor =
    $convert.base64Decode(
        'ChdCbGluZE9iZXJvblRva2VuUmVxdWVzdBIUCgV0b2tlbhgBIAEoDFIFdG9rZW4SGgoIYmxpbmRpbmcYAiADKAxSCGJsaW5kaW5n');
...
final $typed_data.Uint8List unBlindOberonTokenRequestDescriptor =
    $convert.base64Decode(
        'ChlVbkJsaW5kT2Jlcm9uVG9rZW5SZXF1ZXN0EhQKBXRva2VuGAEgASgMUgV0b2tlbhIaCghibGluZGluZxgCIAMoDFIIYmxpbmRpbmc=');
...
final $typed_data.Uint8List verifyOberonTokenRequestDescriptor =
    $convert.base64Decode(
        'ChhWZXJpZnlPYmVyb25Ub2tlblJlcXVlc3QSFAoFdG9rZW4YASABKAxSBXRva2VuEg4KAnBrGAIgASgMUgJwaxISCgRkYXRhGAMgASgMUgRkYXRh');
