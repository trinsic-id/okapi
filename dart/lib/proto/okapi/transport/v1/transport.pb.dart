...
class PackRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set associatedData($core.List<$core.int> v) {
    $_setBytes(2, v);
  }
...
class UnpackRequest extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<UnpackRequest> createRepeated() =>
      $pb.PbList<UnpackRequest>();
  @$core.pragma('dart2js:noInline')
  static UnpackRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UnpackRequest>(create);
...
class UnpackResponse extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<UnpackResponse> createRepeated() =>
      $pb.PbList<UnpackResponse>();
  @$core.pragma('dart2js:noInline')
  static UnpackResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UnpackResponse>(create);
...
class CoreMessage extends $pb.GeneratedMessage {
  ...
  @$core.pragma('dart2js:noInline')
  static CoreMessage getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CoreMessage>(create);
