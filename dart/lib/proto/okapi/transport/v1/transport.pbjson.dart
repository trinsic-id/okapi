...
final $typed_data.Uint8List signRequestDescriptor = $convert.base64Decode(
    'CgtTaWduUmVxdWVzdBIYCgdwYXlsb2FkGAEgASgMUgdwYXlsb2FkEisKA2tleRgCIAEoCzIZLm9rYXBpLmtleXMudjEuSnNvbldlYktleVIDa2V5EjQKCWFwcGVuZF90bxgDIAEoCzIXLnBibXNlLnYxLlNpZ25lZE1lc3NhZ2VSCGFwcGVuZFRv');
...
final $typed_data.Uint8List signResponseDescriptor = $convert.base64Decode(
    'CgxTaWduUmVzcG9uc2USMQoHbWVzc2FnZRgBIAEoCzIXLnBibXNlLnYxLlNpZ25lZE1lc3NhZ2VSB21lc3NhZ2U=');
...
final $typed_data.Uint8List verifyRequestDescriptor = $convert.base64Decode(
    'Cg1WZXJpZnlSZXF1ZXN0EjEKB21lc3NhZ2UYASABKAsyFy5wYm1zZS52MS5TaWduZWRNZXNzYWdlUgdtZXNzYWdlEisKA2tleRgCIAEoCzIZLm9rYXBpLmtleXMudjEuSnNvbldlYktleVIDa2V5');
...
final $typed_data.Uint8List packRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List packResponseDescriptor = $convert.base64Decode(
    'CgxQYWNrUmVzcG9uc2USNAoHbWVzc2FnZRgBIAEoCzIaLnBibXNlLnYxLkVuY3J5cHRlZE1lc3NhZ2VSB21lc3NhZ2U=');
...
final $typed_data.Uint8List unpackRequestDescriptor = $convert.base64Decode(
    'Cg1VbnBhY2tSZXF1ZXN0EjgKCnNlbmRlcl9rZXkYASABKAsyGS5va2FwaS5rZXlzLnYxLkpzb25XZWJLZXlSCXNlbmRlcktleRI8CgxyZWNlaXZlcl9rZXkYAiABKAsyGS5va2FwaS5rZXlzLnYxLkpzb25XZWJLZXlSC3JlY2VpdmVyS2V5EjQKB21lc3NhZ2UYAyABKAsyGi5wYm1zZS52MS5FbmNyeXB0ZWRNZXNzYWdlUgdtZXNzYWdl');
...
final $typed_data.Uint8List coreMessageDescriptor = $convert.base64Decode(
    'CgtDb3JlTWVzc2FnZRIOCgJpZBgBIAEoCVICaWQSEgoEdHlwZRgCIAEoCVIEdHlwZRISCgRib2R5GAMgASgMUgRib2R5Eg4KAnRvGAQgAygJUgJ0bxISCgRmcm9tGAUgASgJUgRmcm9tEh0KB2NyZWF0ZWQYBiABKANSDGNyZWF0ZWRfdGltZRIdCgdleHBpcmVzGAcgASgDUgxleHBpcmVzX3RpbWU=');
