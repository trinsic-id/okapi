...
public class LdProofTest {
  ...
  @Test
  public void testGenerateCapabilityInvocationProofWithJcs()
    ...
    var signingKey =
        response.getKeyList().stream()
            .takeWhile(jsonWebKey -> jsonWebKey.getCrv().equals("Ed25519"))
            .findFirst()
            .get();

    var proofRequest =
        Proofs.CreateProofRequest.newBuilder()
            .setDocument(capability)
            .setKey(signingKey)
