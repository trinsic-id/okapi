...
public inline fun signRequest(
    block: trinsic.okapi.transport.v1.SignRequestKt.Dsl.() -> kotlin.Unit
): trinsic.okapi.transport.v1.Transport.SignRequest =
    trinsic.okapi.transport.v1.SignRequestKt.Dsl._create(
            trinsic.okapi.transport.v1.Transport.SignRequest.newBuilder())
        .apply { block() }
        ._build()
...
public object SignRequestKt {
  ...
  private constructor(
    ...
    public companion object {
      ...
      @kotlin.PublishedApi
      internal fun _create(builder: trinsic.okapi.transport.v1.Transport.SignRequest.Builder): Dsl =
          Dsl(builder)
    }
    ...
    public var appendTo: trinsic.okapi.pbmse.v1.Pbmse.SignedMessage
      @JvmName("getAppendTo") get() = _builder.getAppendTo()
      @JvmName("setAppendTo")
      set(value) {
...
@kotlin.jvm.JvmSynthetic
public inline fun trinsic.okapi.transport.v1.Transport.SignRequest.copy(
    block: trinsic.okapi.transport.v1.SignRequestKt.Dsl.() -> kotlin.Unit
): trinsic.okapi.transport.v1.Transport.SignRequest =
    trinsic.okapi.transport.v1.SignRequestKt.Dsl._create(this.toBuilder())
        .apply { block() }
        ._build()

val trinsic.okapi.transport.v1.Transport.SignRequestOrBuilder.keyOrNull:
    trinsic.okapi.keys.v1.Keys.JsonWebKey?
  get() = if (hasKey()) getKey() else null

val trinsic.okapi.transport.v1.Transport.SignRequestOrBuilder.appendToOrNull:
