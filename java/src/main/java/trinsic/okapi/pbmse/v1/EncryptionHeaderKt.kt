...
public inline fun encryptionHeader(
    block: trinsic.okapi.pbmse.v1.EncryptionHeaderKt.Dsl.() -> kotlin.Unit
): trinsic.okapi.pbmse.v1.Pbmse.EncryptionHeader =
    trinsic.okapi.pbmse.v1.EncryptionHeaderKt.Dsl._create(
            trinsic.okapi.pbmse.v1.Pbmse.EncryptionHeader.newBuilder())
        .apply { block() }
        ._build()
...
public object EncryptionHeaderKt {
  ...
  public class Dsl
  private constructor(private val _builder: trinsic.okapi.pbmse.v1.Pbmse.EncryptionHeader.Builder) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: trinsic.okapi.pbmse.v1.Pbmse.EncryptionHeader.Builder): Dsl =
          Dsl(builder)
    }
    ...
    public var senderKeyId: kotlin.String
      @JvmName("getSenderKeyId") get() = _builder.getSenderKeyId()
...
@kotlin.jvm.JvmSynthetic
public inline fun trinsic.okapi.pbmse.v1.Pbmse.EncryptionHeader.copy(
    block: trinsic.okapi.pbmse.v1.EncryptionHeaderKt.Dsl.() -> kotlin.Unit
): trinsic.okapi.pbmse.v1.Pbmse.EncryptionHeader =
    trinsic.okapi.pbmse.v1.EncryptionHeaderKt.Dsl._create(this.toBuilder())
        .apply { block() }
        ._build()
