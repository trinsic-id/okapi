...
public inline fun encryptedMessage(
    block: trinsic.okapi.pbmse.v1.EncryptedMessageKt.Dsl.() -> kotlin.Unit
): trinsic.okapi.pbmse.v1.Pbmse.EncryptedMessage =
    trinsic.okapi.pbmse.v1.EncryptedMessageKt.Dsl._create(
            trinsic.okapi.pbmse.v1.Pbmse.EncryptedMessage.newBuilder())
        .apply { block() }
        ._build()
...
public object EncryptedMessageKt {
  ...
  public class Dsl
  private constructor(private val _builder: trinsic.okapi.pbmse.v1.Pbmse.EncryptedMessage.Builder) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: trinsic.okapi.pbmse.v1.Pbmse.EncryptedMessage.Builder): Dsl =
          Dsl(builder)
    }
    ...
    public var iv: com.google.protobuf.ByteString
      @JvmName("getIv") get() = _builder.getIv()
      @JvmName("setIv")
      set(value) {
    ...
    public var aad: com.google.protobuf.ByteString
      @JvmName("getAad") get() = _builder.getAad()
      @JvmName("setAad")
      set(value) {
    ...
    public var ciphertext: com.google.protobuf.ByteString
      @JvmName("getCiphertext") get() = _builder.getCiphertext()
    ...
    public var tag: com.google.protobuf.ByteString
      @JvmName("getTag") get() = _builder.getTag()
      @JvmName("setTag")
      set(value) {
    ...
    public val recipients:
        com.google.protobuf.kotlin.DslList<
            trinsic.okapi.pbmse.v1.Pbmse.EncryptionRecipient, RecipientsProxy>
      @kotlin.jvm.JvmSynthetic
      get() = com.google.protobuf.kotlin.DslList(_builder.getRecipientsList())
    /**
     * <code>repeated .pbmse.v1.EncryptionRecipient recipients = 5;</code>
    ...
    public fun com.google.protobuf.kotlin.DslList<
        trinsic.okapi.pbmse.v1.Pbmse.EncryptionRecipient, RecipientsProxy>
        .add(value: trinsic.okapi.pbmse.v1.Pbmse.EncryptionRecipient) {
    ...
    public inline operator fun com.google.protobuf.kotlin.DslList<
        trinsic.okapi.pbmse.v1.Pbmse.EncryptionRecipient, RecipientsProxy>
        .plusAssign(value: trinsic.okapi.pbmse.v1.Pbmse.EncryptionRecipient) {
      add(value)
    }
    /**
     * <code>repeated .pbmse.v1.EncryptionRecipient recipients = 5;</code>
    ...
    public fun com.google.protobuf.kotlin.DslList<
        trinsic.okapi.pbmse.v1.Pbmse.EncryptionRecipient, RecipientsProxy>
        .addAll(
        values: kotlin.collections.Iterable<trinsic.okapi.pbmse.v1.Pbmse.EncryptionRecipient>
    ) {
    ...
    public operator fun com.google.protobuf.kotlin.DslList<
        trinsic.okapi.pbmse.v1.Pbmse.EncryptionRecipient, RecipientsProxy>
        .set(index: kotlin.Int, value: trinsic.okapi.pbmse.v1.Pbmse.EncryptionRecipient) {
...
@kotlin.jvm.JvmSynthetic
public inline fun trinsic.okapi.pbmse.v1.Pbmse.EncryptedMessage.copy(
    block: trinsic.okapi.pbmse.v1.EncryptedMessageKt.Dsl.() -> kotlin.Unit
): trinsic.okapi.pbmse.v1.Pbmse.EncryptedMessage =
    trinsic.okapi.pbmse.v1.EncryptedMessageKt.Dsl._create(this.toBuilder())
        .apply { block() }
        ._build()
