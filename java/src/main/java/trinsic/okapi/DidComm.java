...
public class DidComm extends OkapiNative {
  public static Transport.PackResponse pack(Transport.PackRequest request)
  ...
  public static Transport.UnpackResponse unpack(Transport.UnpackRequest request)
      throws DidException, InvalidProtocolBufferException {
    OkapiByteBuffer.ByValue requestBuffer = messageToBuffer(request);
    OkapiByteBuffer responseBuffer = new OkapiByteBuffer();
    ExternError errBuffer = new ExternError();
  ...
  public static Transport.SignResponse sign(Transport.SignRequest request)
      throws DidException, InvalidProtocolBufferException {
    OkapiByteBuffer.ByValue requestBuffer = messageToBuffer(request);
    OkapiByteBuffer responseBuffer = new OkapiByteBuffer();
    ExternError errBuffer = new ExternError();
  ...
  public static Transport.VerifyResponse verify(Transport.VerifyRequest request)
      throws DidException, InvalidProtocolBufferException {
    OkapiByteBuffer.ByValue requestBuffer = messageToBuffer(request);
    OkapiByteBuffer responseBuffer = new OkapiByteBuffer();
    ExternError errBuffer = new ExternError();
