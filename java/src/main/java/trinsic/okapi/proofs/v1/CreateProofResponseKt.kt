...
public inline fun createProofResponse(
    block: trinsic.okapi.proofs.v1.CreateProofResponseKt.Dsl.() -> kotlin.Unit
): trinsic.okapi.proofs.v1.Proofs.CreateProofResponse =
    trinsic.okapi.proofs.v1.CreateProofResponseKt.Dsl._create(
            trinsic.okapi.proofs.v1.Proofs.CreateProofResponse.newBuilder())
        .apply { block() }
        ._build()
  ...
  private constructor(
    ...
    public companion object {
      ...
      internal fun _create(
          builder: trinsic.okapi.proofs.v1.Proofs.CreateProofResponse.Builder
      ): Dsl = Dsl(builder)
    }
    ...
    public var signedDocument: com.google.protobuf.Struct
      @JvmName("getSignedDocument") get() = _builder.getSignedDocument()
...
@kotlin.jvm.JvmSynthetic
public inline fun trinsic.okapi.proofs.v1.Proofs.CreateProofResponse.copy(
    block: trinsic.okapi.proofs.v1.CreateProofResponseKt.Dsl.() -> kotlin.Unit
): trinsic.okapi.proofs.v1.Proofs.CreateProofResponse =
    trinsic.okapi.proofs.v1.CreateProofResponseKt.Dsl._create(this.toBuilder())
        .apply { block() }
        ._build()

val trinsic.okapi.proofs.v1.Proofs.CreateProofResponseOrBuilder.signedDocumentOrNull:
