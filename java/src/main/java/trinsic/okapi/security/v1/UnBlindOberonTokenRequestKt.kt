...
public inline fun unBlindOberonTokenRequest(
    block: trinsic.okapi.security.v1.UnBlindOberonTokenRequestKt.Dsl.() -> kotlin.Unit
): trinsic.okapi.security.v1.Security.UnBlindOberonTokenRequest =
    trinsic.okapi.security.v1.UnBlindOberonTokenRequestKt.Dsl._create(
            trinsic.okapi.security.v1.Security.UnBlindOberonTokenRequest.newBuilder())
        .apply { block() }
        ._build()
  ...
  private constructor(
    ...
    public companion object {
      ...
      internal fun _create(
          builder: trinsic.okapi.security.v1.Security.UnBlindOberonTokenRequest.Builder
      ): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): trinsic.okapi.security.v1.Security.UnBlindOberonTokenRequest =
        _builder.build()
    ...
    /**
     * <pre> blinding to remove from the token </pre>
     *
...
@kotlin.jvm.JvmSynthetic
public inline fun trinsic.okapi.security.v1.Security.UnBlindOberonTokenRequest.copy(
    block: trinsic.okapi.security.v1.UnBlindOberonTokenRequestKt.Dsl.() -> kotlin.Unit
): trinsic.okapi.security.v1.Security.UnBlindOberonTokenRequest =
    trinsic.okapi.security.v1.UnBlindOberonTokenRequestKt.Dsl._create(this.toBuilder())
        .apply { block() }
        ._build()
