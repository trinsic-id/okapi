...
@kotlin.jvm.JvmName("-initializeblindOberonTokenRequest")
public inline fun blindOberonTokenRequest(
    block: trinsic.okapi.security.v1.BlindOberonTokenRequestKt.Dsl.() -> kotlin.Unit
): trinsic.okapi.security.v1.Security.BlindOberonTokenRequest =
    trinsic.okapi.security.v1.BlindOberonTokenRequestKt.Dsl._create(
            trinsic.okapi.security.v1.Security.BlindOberonTokenRequest.newBuilder())
        .apply { block() }
        ._build()

public object BlindOberonTokenRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl
  private constructor(
      private val _builder: trinsic.okapi.security.v1.Security.BlindOberonTokenRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(
          builder: trinsic.okapi.security.v1.Security.BlindOberonTokenRequest.Builder
      ): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): trinsic.okapi.security.v1.Security.BlindOberonTokenRequest =
        _builder.build()
    ...
    /**
     * <pre> blinding to apply to the token </pre>
     *
...
@kotlin.jvm.JvmSynthetic
public inline fun trinsic.okapi.security.v1.Security.BlindOberonTokenRequest.copy(
    block: trinsic.okapi.security.v1.BlindOberonTokenRequestKt.Dsl.() -> kotlin.Unit
): trinsic.okapi.security.v1.Security.BlindOberonTokenRequest =
    trinsic.okapi.security.v1.BlindOberonTokenRequestKt.Dsl._create(this.toBuilder())
        .apply { block() }
        ._build()
