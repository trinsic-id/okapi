...
class KeyTest < Minitest::Test
  ...
  def test_generate_key
    ...
    assert !response.nil?
    assert response.is_a?(Okapi::Keys::V1::GenerateKeyResponse)
  end
  ...
  def test_resolve_key
    ...
    response = Okapi::DidKey.resolve(Okapi::Keys::V1::ResolveRequest.new(did: key))
    assert !response.nil?
  end
  ...
  def test_generate_key_from_seed
    type = Okapi::Keys::V1::KeyType::KEY_TYPE_ED25519
    type_string = 'Ed25519'
    ...
    type = Okapi::Keys::V1::KeyType::KEY_TYPE_X25519
    type_string = 'X25519'
