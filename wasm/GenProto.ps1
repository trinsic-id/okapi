...
$OUTPUT_DIR="./packages/didcomm-grpc/src/proto"
$PROTO_DIR="../proto"
...
Invoke-Expression "$GRPC_TOOLS_NODE_PROTOC --plugin=protoc-gen-ts=$PROTOC_GEN_TS_PATH --ts_out=$OUTPUT_DIR -I $PROTO_DIR $PROTO_DIR/*.proto"
