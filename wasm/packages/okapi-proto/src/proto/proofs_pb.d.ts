...
export class CreateProofRequest extends jspb.Message { 
    ...
    setDocument(value?: google_protobuf_struct_pb.Struct): CreateProofRequest;

    hasKey(): boolean;
    clearKey(): void;
    getKey(): keys_pb.JsonWebKey | undefined;
    setKey(value?: keys_pb.JsonWebKey): CreateProofRequest;
    getSuite(): LdSuite;
    setSuite(value: LdSuite): CreateProofRequest;
...
export class CreateProofResponse extends jspb.Message { 
    ...
    setSignedDocument(value?: google_protobuf_struct_pb.Struct): CreateProofResponse;
