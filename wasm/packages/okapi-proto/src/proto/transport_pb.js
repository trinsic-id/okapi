...
goog.exportSymbol('proto.okapi.transport.NoOp', null, global);
 ...
 * @constructor
 */
proto.okapi.transport.NoOp = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.okapi.transport.NoOp, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.okapi.transport.NoOp.displayName = 'proto.okapi.transport.NoOp';
}
 ...
 * @return {!Object}
 */
proto.okapi.transport.NoOp.prototype.toObject = function(opt_includeInstance) {
  return proto.okapi.transport.NoOp.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.okapi.transport.NoOp} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.okapi.transport.NoOp.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.okapi.transport.NoOp}
 */
proto.okapi.transport.NoOp.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.okapi.transport.NoOp;
  return proto.okapi.transport.NoOp.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.okapi.transport.NoOp} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.okapi.transport.NoOp}
 */
proto.okapi.transport.NoOp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.okapi.transport.NoOp.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.okapi.transport.NoOp.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.okapi.transport.NoOp} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.okapi.transport.NoOp.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
