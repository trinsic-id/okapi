  ...
  fromJSON(object: any): SignRequest {
    return {
      ...
      appendTo: isSet(object.appendTo)
        ? SignedMessage.fromJSON(object.appendTo)
        : undefined,
    };
  },
  ...
  toJSON(message: SignRequest): unknown {
    ...
    message.appendTo !== undefined &&
      (obj.appendTo = message.appendTo
        ? SignedMessage.toJSON(message.appendTo)
        : undefined);
    return obj;
  },
  ...
  fromJSON(object: any): SignResponse {
    return {
      message: isSet(object.message)
        ? SignedMessage.fromJSON(object.message)
        : undefined,
    };
  },
  ...
  toJSON(message: SignResponse): unknown {
    ...
    message.message !== undefined &&
      (obj.message = message.message
        ? SignedMessage.toJSON(message.message)
        : undefined);
    return obj;
  },
  ...
  fromJSON(object: any): PackRequest {
    return {
      senderKey: isSet(object.senderKey)
        ? JsonWebKey.fromJSON(object.senderKey)
        : undefined,
      receiverKey: isSet(object.receiverKey)
        ? JsonWebKey.fromJSON(object.receiverKey)
        : undefined,
      ...
      algorithm: isSet(object.algorithm)
        ? encryptionAlgorithmFromJSON(object.algorithm)
        : 0,
    };
  },
  ...
  toJSON(message: PackRequest): unknown {
    ...
    message.senderKey !== undefined &&
      (obj.senderKey = message.senderKey
        ? JsonWebKey.toJSON(message.senderKey)
        : undefined);
    message.receiverKey !== undefined &&
      (obj.receiverKey = message.receiverKey
        ? JsonWebKey.toJSON(message.receiverKey)
        : undefined);
    ...
    message.plaintext !== undefined &&
      (obj.plaintext = base64FromBytes(
        message.plaintext !== undefined ? message.plaintext : new Uint8Array()
      ));
    message.mode !== undefined &&
      (obj.mode = encryptionModeToJSON(message.mode));
...
export const PackResponse = {
  ...
  fromJSON(object: any): PackResponse {
    return {
      message: isSet(object.message)
        ? EncryptedMessage.fromJSON(object.message)
        : undefined,
    };
  },
  ...
  toJSON(message: PackResponse): unknown {
    ...
    message.message !== undefined &&
      (obj.message = message.message
        ? EncryptedMessage.toJSON(message.message)
        : undefined);
    return obj;
  },
