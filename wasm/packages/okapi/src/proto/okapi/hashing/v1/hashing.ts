...
export const Blake3HashRequest = {
  encode(message: Blake3HashRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
...
export const Blake3HashResponse = {
  encode(message: Blake3HashResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): Blake3HashResponse {
    return { digest: isSet(object.digest) ? bytesFromBase64(object.digest) : new Uint8Array() };
  },
...
export const Blake3KeyedHashRequest = {
  encode(message: Blake3KeyedHashRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.data.length !== 0) {
      writer.uint32(10).bytes(message.data);
    }
...
export const Blake3KeyedHashResponse = {
  encode(message: Blake3KeyedHashResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.digest.length !== 0) {
      writer.uint32(10).bytes(message.digest);
    }
    return writer;
...
export const Blake3DeriveKeyRequest = {
  encode(message: Blake3DeriveKeyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): Blake3DeriveKeyRequest {
    return {
      context: isSet(object.context) ? bytesFromBase64(object.context) : new Uint8Array(),
  ...
  toJSON(message: Blake3DeriveKeyRequest): unknown {
    ...
    message.keyMaterial !== undefined
      && (obj.keyMaterial = base64FromBytes(
        message.keyMaterial !== undefined ? message.keyMaterial : new Uint8Array(),
      ));
    return obj;
  },
...
export const Blake3DeriveKeyResponse = {
  encode(message: Blake3DeriveKeyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.digest.length !== 0) {
      writer.uint32(10).bytes(message.digest);
    }
    return writer;
...
export const SHA256HashRequest = {
  encode(message: SHA256HashRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.data.length !== 0) {
      writer.uint32(10).bytes(message.data);
    }
    return writer;
...
export const SHA256HashResponse = {
  encode(message: SHA256HashResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.digest.length !== 0) {
      writer.uint32(10).bytes(message.digest);
    }
    return writer;
