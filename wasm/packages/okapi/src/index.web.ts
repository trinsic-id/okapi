...
export class Oberon {
  static async createKey(
    ...
    await initialize();
    return proto.CreateOberonKeyResponse.deserializeBinary(
  ...
  static async createToken(
    ...
    await initialize();
    return proto.CreateOberonTokenResponse.deserializeBinary(
  ...
  static async createProof(
    ...
    await initialize();
    return proto.CreateOberonProofResponse.deserializeBinary(
  ...
  static async verifyProof(
    ...
    await initialize();
    return proto.VerifyOberonProofResponse.deserializeBinary(
  ...
  static async blindToken(
    ...
    await initialize();
    return proto.BlindOberonTokenResponse.deserializeBinary(
  ...
  static async unblindToken(
    ...
    await initialize();
    return proto.UnBlindOberonTokenResponse.deserializeBinary(
