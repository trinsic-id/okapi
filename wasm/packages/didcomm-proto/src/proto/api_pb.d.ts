...
export class ResolveKeyRequest extends jspb.Message {
  getDidUri(): string;
  setDidUri(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ResolveKeyRequest.AsObject;
  static toObject(includeInstance: boolean, msg: ResolveKeyRequest): ResolveKeyRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ResolveKeyRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ResolveKeyRequest;
  static deserializeBinaryFromReader(message: ResolveKeyRequest, reader: jspb.BinaryReader): ResolveKeyRequest;
}

export namespace ResolveKeyRequest {
  export type AsObject = {
    didUri: string,
  }
}

export class ResolveKeyResponse extends jspb.Message {
  hasKey(): boolean;
  clearKey(): void;
  getKey(): JsonWebKey | undefined;
  setKey(value?: JsonWebKey): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ResolveKeyResponse.AsObject;
  static toObject(includeInstance: boolean, msg: ResolveKeyResponse): ResolveKeyResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ResolveKeyResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ResolveKeyResponse;
  static deserializeBinaryFromReader(message: ResolveKeyResponse, reader: jspb.BinaryReader): ResolveKeyResponse;
}

export namespace ResolveKeyResponse {
  export type AsObject = {
    key?: JsonWebKey.AsObject,
  }
}
