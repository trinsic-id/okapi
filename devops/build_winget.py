...
shutil.copytree(os.path.join(okapi_winget_path, existing_version), release_manifest, dirs_exist_ok=True)
...
installer_doc['Installers'][0]['InstallerUrl'] = [asset['browser_download_url'] for asset in release_json[0]['assets'] if str(asset['browser_download_url']).endswith('.msi')][0]
